...
// If clicked text, change target to parent button.
// If clicked button, nice one.
// If clicked icon, change target to parent button.
// Set children of button to toggle active class.